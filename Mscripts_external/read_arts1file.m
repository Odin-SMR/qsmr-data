...
% HISTORY: 20.05.15  Copied from AMI, and renamed for clarity (no changes
%                    inside file). PE.
%          00.04.12  First version by Patrick Eriksson (PE).
%          00.11.09  Included binary files (PE)


function x = read_arts1file(filename,artstype,isascii)
